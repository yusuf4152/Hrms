...
public class CDWKPSPublicSoap
{
    ...
    public CDWKPSPublicSoap(){}

    public CDWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CDWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CDWExtendedSoapSerializationEnvelope envelope= new CDWExtendedSoapSerializationEnvelope(CDWExtendedSoapSerializationEnvelope.VER11);
