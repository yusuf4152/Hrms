...
public class CDWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CDWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new CDWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CDWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CDWDateTimeConverter dateTimeConverter = new CDWStandardDateTimeConverter();

    public CDWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CDWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CDWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CDWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CDWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CDWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
